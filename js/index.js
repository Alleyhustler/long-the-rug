...
function injectWow() {
  ...
  newWow.innerText = "Top blast here"
  ...
  if (wows === 10) {
    lengthEl.innerText = "Long"
  }

  if (wows === 50) {
    lengthEl.innerText = "Very long"
  }

  if (wows === 100) {
    lengthEl.innerText = "much Long"
  }

  if (wows === 150) {
    lengthEl.innerText = "long much Long"
  }

  if (wows === 250) {
    lengthEl.innerText = "very long much long"
  }

  if (wows === 500) {
    lengthEl.innerText = "wow very long much long"
  }

  if (wows === 1000) {
    lengthEl.innerText = "much wow very long much long!"
  }
  ...
  if (wows === 10000) {
    lengthEl.innerText = "many many long amaze"
  }

  if (wows === 30000) {
    lengthEl.innerText = "amaze long dont forget to print!"
  }

  if (wows === 50000) {
    lengthEl.innerText = "longlonglonglonglonglonglonglong"
  }

  if (wows === 80000) {
    lengthEl.innerText = "longlonglonglonglonglonglonglonglonglonglonglonglong"
  }
...
function injectLargeWow() {
  ...
  const newWow = document.createElement("div")
  newWow.className = "largelong"
  newWow.innerText = "longs"
